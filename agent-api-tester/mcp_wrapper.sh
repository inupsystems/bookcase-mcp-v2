...
export PYTHONPATH="/home/john/workspace/bookcase-mcp/agent-api-tester/src"
# Remove API_SPEC_FILE to prioritize tools storage
# export API_SPEC_FILE="/home/john/workspace/bookcase-mcp/agent-api-tester/examples/jsonplaceholder-api.json"
...
cd /home/john/workspace/bookcase-mcp/agent-api-tester/src

# Run the MCP stdio server
exec /home/john/workspace/bookcase-mcp/agent-api-tester/venv/bin/python -m api_agent.cli mcp-stdio
