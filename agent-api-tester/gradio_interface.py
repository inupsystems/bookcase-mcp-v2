...
def get_test_monitor_results():
    """Obtém resultados do monitor de testes."""
    try:
...
def get_dashboard_data():
    ...
    try:
        ...
        # Calcular métricas usando os dados corretos
        test_results = current_status.get('test_results', [])
        tools_tested_list = current_status.get('tools_tested', [])
        ...
        # Se tools_tested é um número, usar ele diretamente, senão calcular len()
        if isinstance(tools_tested_list, int):
            tools_tested = tools_tested_list
        else:
            tools_tested = len(tools_tested_list)
        
        # Usar tools_tested_count se disponível
        if 'tools_tested_count' in current_status:
            tools_tested = current_status['tools_tested_count']
